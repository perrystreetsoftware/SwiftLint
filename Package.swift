...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/realm/SwiftLint/releases/download/0.0.3/SwiftLintBinary-macos.artifactbundle.zip",
            checksum: "0e6b1f040f85e850653f3bd762da427a3c847607a920a1c1a502e49a05889f56"
        )
    ]
)
