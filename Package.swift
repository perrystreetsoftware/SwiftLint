...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/perrystreetsoftware/SwiftLint/releases/download/0.0.13/SwiftLintBinary-macos.artifactbundle.zip",
            checksum: "c4579c0addbd1d07c02c196f4f54b3569bb1cb69f1d8ac564aa29a9fda77938f"
        )
    ]
)
