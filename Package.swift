...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/perrystreetsoftware/SwiftLint/releases/download/0.0.19/SwiftLintBinary-macos.artifactbundle.zip",
            checksum: "57f3678ce8c4fa120848172a6999d103070932c1716e772ab742dad0863198ca"
        ),
        .macro(
