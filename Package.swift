...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/realm/SwiftLint/releases/download/0.0.2/SwiftLintBinary-macos.artifactbundle.zip",
            checksum: "76b9361c0db2dda7e9e419bc819a00a3f25d50426503ac649df7507e57698a75"
        )
    ]
)
