...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/perrystreetsoftware/SwiftLint/releases/download/0.0.16/SwiftLintBinary-macos.artifactbundle.zip",
            checksum: "afdb85f2d34c8547dd89c26f50b53afb584cb37124ad0a85fae6d1606c4fb5b5"
        ),
        .macro(
