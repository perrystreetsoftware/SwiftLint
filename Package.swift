...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/realm/SwiftLint/releases/download/0.0.1/SwiftLintBinary-macos.artifactbundle.zip",
            checksum: "4d8224fe2cc559c77249d1457fc1f5b1a7ae4fed33f80a4467f201781e0e5b9e"
        )
    ]
)
