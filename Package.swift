...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/perrystreetsoftware/SwiftLint/releases/download/0.0.12/SwiftLintBinary-macos.artifactbundle.zip",
            checksum: "219e4f5d50ba24becba60872d2a31e05161af5115d4faca38db49748db4838ee"
        )
    ]
)
